    ...
    return(
        <div>
            ...
            <div className='telaInicio'>
                ...
                <Button className='btMenu' id="TelaUsuario"  onClick={() => navigate('/TelaUsuario')}>Usuário</Button>
                <Button className='btMenu' id="TelaProduto"  onClick={() => navigate('/TelaProduto')}>Produto</Button> 
                <Button className='btMenu' id="TelaEtiqueta">Etiqueta</Button>
                <input className='btPesquisa' type='text' placeholder='Buscar...' onChange={e => setSearch(e.target.value)} value={search}/>
                </div>

                <div className='IniciProduto'>
                    <Table dadosProdutos = {dadosProdutos} head={head} filterDados={filterDados}/>
                </div>

                <div className='btsBaixo'>
                <Button className='btGrupoAla' onClick={() => navigate('/TelaCadastrarGrupo')}>Grupo +</Button>
                <Button className='btGrupoAla' onClick={() => navigate('/TelaCadastrarAla')}>Ala +</Button>
