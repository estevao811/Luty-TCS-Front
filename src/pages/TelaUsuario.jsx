    ...
    return(
        <body>
            ...
            <div className='botoes'>
                ...
                <Button className='btMenu' id='produto' onClick={() => navigate('/TelaProduto')}>Produto</Button>{''}
                <Button className='btMenu' id='Etiqueta' onClick={() => navigate('/TelaEtiqueta')}>Etiqueta</Button>{''}
